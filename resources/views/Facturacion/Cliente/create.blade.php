                ...
                {{ Form::open(array('url' => URL::route('Cliente.store'), 'method' => 'post'))}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                ...
                                <input id="Cedula" type="text" class="form-control" placeholder="Ingresa cedula del cliente" name="Cedula">
                        </div>
                        @error('Cedula')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Ingresa la dirección del cliente" name="Direccion">
                        </div>
                        @error('Direccion')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
